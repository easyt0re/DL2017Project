...
# check this next line because the address
from ..utils.upsampling import bilinear_upsample_weights

slim = tf.contrib.slim

# # YW: do we need some inception_preprocessing
# # Mean values for VGG-16
# from preprocessing.vgg_preprocessing import _R_MEAN, _G_MEAN, _B_MEAN


def extract_inception_v3_mapping_without_fc8(vgg_16_variables_mapping):
...
def FCN_32s(image_batch_tensor,
    ...
    with tf.variable_scope("fcn_32s") as fcn_32s_scope:
        ...
        # # TO CHECK what to to with this part preprocessing
        ...
        with slim.arg_scope(inception_v3.inception_v3_arg_scope()):
            ...
            logits, end_points = inception_v3.inception_v3(image_batch_tensor,
        ...
        inception_v3_variables_mapping = {}

        inception_v3_variables = slim.get_variables(fcn_32s_scope)

        for variable in inception_v3_variables:
            ...
            original_inception_v3_checkpoint_string = variable.name[len(fcn_32s_scope.name)+1:-2]
            inception_v3_variables_mapping[original_inception_v3_checkpoint_string] = variable

    return upsampled_logits, inception_v3_variables_mapping